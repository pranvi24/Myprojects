...
<div class="Nav" id="Nav1">
  <div class="NavbarContainer">
    <img src="images\jspm.png" alt="" class="NavLogo" onclick="rtohome()">
...
<div class="FooterWrap">
  ...
  <div class="SocialMedia">
    <div class="SocialMediaWrap">
      ...
      <p class="WebsiteRights">JSPM's RSCOE PUNE © 2024</p>
      <div class="SocialIcons">
        <a href="https://www.facebook.com/rscoepune/" class="SocialIconLink"><i class="fa fa-facebook-square" aria-hidden="true"></i></a>
        <a href="https://twitter.com/rscoe_official?lang=en" class="SocialIconLink"><i class="fa fa-twitter" aria-hidden="true"></i></a>
        <a href="https://www.instagram.com/jspmrscoe_official/?hl=en" class="SocialIconLink"><i class="fa fa-instagram" aria-hidden="true"></i></a>
        <a href="https://www.youtube.com/channel/UC4wJUeP0U9ziXWnPe-nKYmw" class="SocialIconLink"><i class="fa-brands fa-youtube"></i></a>
      </div>
    </div>
